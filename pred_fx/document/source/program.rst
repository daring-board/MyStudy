...
.. code:: python
  ...
  python calc_return3.py 5d

文法

.. code:: python

  python calc_return3.py [モデル更新期間]
...
.. code:: python
  ...
  python calc_return7.py 30000 7203 train

文法

.. code:: python

  python calc_return7.py [Loop] [stock] [train or pred]
...
.. code:: python
  ...
  python calc_return5.py 1000 7203 train

文法

.. code:: python

  python calc_return5.py [Loop] [stock] [train or pred]
